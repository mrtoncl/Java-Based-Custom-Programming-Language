public class XorExpression extends BinaryLogicalExpression{
    ...
    XorExpression(Expression bool1, Expression bool2){
        this.bool1 = bool1;
        this.bool2 = bool2;
    }
    ...
    Expression execute() {
        ...
        if((boolean) bool1.getValue()){             //Checking the type of values (if any of them is invalid type throwing exception) and executing the expression.
